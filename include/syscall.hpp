...
class Sys_call : public Sys_regs
{
    public:
        ...
        ALWAYS_INLINE
        inline unsigned long pt() const { return ARG_2; /* ARG_1 >> 9;*/ }
};
...
class Sys_hpc_ctrl : public Sys_regs
{
    public:
        ...
        ALWAYS_INLINE
        inline mword sel() const { return ARG_1 >> 9; }
        ...
        ALWAYS_INLINE
        inline mword counter() const { return ARG_1 >> 9; }
...
class Sys_alloc_core : public Sys_regs
{
    public:
        ...
        inline void set_remainder(mword remainder) { ARG_4 = remainder; }
};
